...
<head>
    <title>科室领用详情</title>
    <link rel="stylesheet" type="text/css" href="http://localhost:8080/depot/draw/css/detail.css">
    ...
    <script language="JavaScript">
        ...
        //打开添加页面
        function insert(obj) {
            window.open("/depot/draw/detail_insert.jsp?draw_no="+obj,"_blank","width=1000, height=600,left=480px,top=170px");
        }

        //查询
        function select() {
            $.ajax({
                url:"/depotDraw/detail_select",
                type:"post",
                data:{
...
<div class="button">
    <br/>
    <button id="insert" onclick="insert(${param.draw_no})">添加</button>
