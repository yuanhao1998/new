...
<head>
    <title>资产处置详情页</title>
    <link rel="stylesheet" type="text/css" href="http://localhost:8080/scrap/css/detail.css">
    ...
    <script language="JavaScript">
        //打开添加页面
        function insert(obj) {
            window.open("/scrap/detail_insert.jsp?scrap_no="+obj,"_blank","width=1000, height=600,left=480px,top=170px");
        }
        //当单据审核或者生成卡片后无法修改
        function init() {
        ...
        function select() {
            $.ajax({
                url:"/Scrap/detail_select",
                type:"post",
                data:{
                    "scrap_no":${param.scrap_no},
                    "src": "detail_select"
                },
...
<div class="button">
    <br/>
    <button id="insert" onclick="insert(${param.scrap_no})">添加</button>
